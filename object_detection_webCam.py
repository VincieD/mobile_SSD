...
import object_detection_old.utils.label_map_util as label_map_util
import object_detection_old.utils.visualization_utils as vis_util
...
def detection(detection_graph, category_index, score, expand):
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph,config=config) as sess:
            ...
            print ('Image weight, height and number of channels:{}px {}px {}channels'.format(height, width, channels))
